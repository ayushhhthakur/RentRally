...
const TermsAndConditions = () => {
  return (
    <Wrapper >
      <HeroPages name='Terms and Conditions' />
    <div>
      ...
      <ul>
        ...
        <li>Your use of this website and any dispute arising out of such use of the website is subject to the laws of [insert country].</li>
      </ul>
    </div>
    </Wrapper>
  );
...
/* FILEPATH: /C:/Users/ayush/OneDrive/Desktop/WORK/RentRally/src/Pages/TermsAndConditions.css */
.container {
  max-width: 800px;
  margin: 0 auto;
  padding: 20px;
